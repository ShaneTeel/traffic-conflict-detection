...
class Render:
    ...
    def resize_frame(self, frame:NDArray, max_width:int):
        h, w = frame.shape[:2]
        if w > max_width:
            ratio = max_width / w
            w = max_width
